...
extension MapViewController {
    ...
    static func instantiate(initialData: MapInitialData, coordinator: MapCoordinatorDelegate, networkingService: NetworkingServiceType) -> MapViewType {
        let viewController = MapViewController()
        let modelController = MapModelController(initialData: initialData, networkingService: networkingService)
